...
public class defaultComponentComponentTest extends CamelTestSupport {
    ...
    protected RouteBuilder createRouteBuilder() throws Exception {
        return new RouteBuilder() {
            public void configure() {
                from("defaultScheme://foo?greetingsMessage=Hello world1")
                  .to("defaultScheme://bar?greetingsMessage=Hello world2")
                  .to("mock:result");
            }
        };
    }
