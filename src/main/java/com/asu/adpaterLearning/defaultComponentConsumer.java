 ...
 */
public class defaultComponentConsumer extends ScheduledPollConsumer {
    private Logger LOG = LoggerFactory.getLogger(defaultComponentConsumer.class);

    private final defaultComponentEndpoint endpoint;


    public defaultComponentConsumer(final defaultComponentEndpoint endpoint, final Processor processor) {
