 ...
 */
public class defaultComponentProducer extends DefaultProducer {
    private static final transient Logger LOG = LoggerFactory.getLogger(defaultComponentProducer.class);
    private defaultComponentEndpoint endpoint;

	public defaultComponentProducer(defaultComponentEndpoint endpoint) {
        super(endpoint);
